                ...
                match param {
                    KindParam::Ident(ident) => {
                        ...
                        match geom_name.as_str() {
                            ...
                            "line" => geom_kinds.push(quote! { srrldb_types::GeometryKind::Line }),
                            "polygon" => {
                                geom_kinds.push(quote! { srrldb_types::GeometryKind::Polygon })
                            }
                            "multipoint" => {
                                geom_kinds.push(quote! { srrldb_types::GeometryKind::MultiPoint })
                            }
                            "multiline" => {
                                geom_kinds.push(quote! { srrldb_types::GeometryKind::MultiLine })
                            }
                            "multipolygon" => {
                                geom_kinds.push(quote! { srrldb_types::GeometryKind::MultiPolygon })
                            }
                            "collection" => {
                                geom_kinds.push(quote! { srrldb_types::GeometryKind::Collection })
                            }
                            _ => {}
                        }
                    }
