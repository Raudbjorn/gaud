...
mod tests {
    ...
    fn key() {
        ...
        assert_eq!(
            enc,
            b"/*\0\0\0\x7B*\0\0\0\xEA*testtb\0!ih\x80\0\0\0\0\0\0\x0F"
        );
    }
    ...
    fn range() {
        ...
        assert_eq!(
            r.start,
            b"/*\0\0\0\x7B*\0\0\0\xEA*testtb\0!ih\0\0\0\0\0\0\0\0"
        );
        assert_eq!(
            r.end,
            b"/*\0\0\0\x7B*\0\0\0\xEA*testtb\0!ih\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF"
        );
    }
}
