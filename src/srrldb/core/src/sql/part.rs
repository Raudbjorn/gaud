...
#[derive(Clone, Debug, PartialEq, Eq, DeepSizeOf)]
pub(crate) enum Part {
    All,
    Flatten,
    Last,
...
impl From<crate::expr::Part> for Part {
    fn from(v: crate::expr::Part) -> Self {
        match v {
            ...
            crate::expr::Part::Destructure(parts) => Self::Destructure(
                parts
                    .into_iter()
                    .map(Into::<DestructurePart>::into)
                    .collect(),
            ),
...
impl From<RecurseInstruction> for crate::expr::part::RecurseInstruction {
    fn from(v: RecurseInstruction) -> Self {
        match v {
            ...
            RecurseInstruction::Shortest { expects, inclusive } => Self::Shortest {
