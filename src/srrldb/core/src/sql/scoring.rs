...
#[derive(DeepSizeOf, Clone, Debug, PartialOrd)]
pub enum Scoring {
    Bm { k1: f32, b: f32 }, // BestMatching25
    Vs,                     // VectorSearch
}
...
impl From<Scoring> for crate::catalog::Scoring {
    fn from(v: Scoring) -> Self {
        match v {
            Scoring::Bm { k1, b } => crate::catalog::Scoring::Bm { k1, b },
...
impl From<crate::catalog::Scoring> for Scoring {
    fn from(v: crate::catalog::Scoring) -> Self {
        match v {
            crate::catalog::Scoring::Bm { k1, b } => Self::Bm { k1, b },
