...
pub(super) static ROCKSDB_THREAD_COUNT: LazyLock<i32> =
    lazy_env_parse!("SURREAL_ROCKSDB_THREAD_COUNT", i32, || num_cpus::get()
        as i32);

/// The maximum number of threads to use for flushing and compaction (default:
/// number of CPUs * 2)
pub(super) static ROCKSDB_JOBS_COUNT: LazyLock<i32> =
    lazy_env_parse!("SURREAL_ROCKSDB_JOBS_COUNT", i32, || num_cpus::get() as i32
        * 2);
...
pub(super) static ROCKSDB_TARGET_FILE_SIZE_BASE: LazyLock<u64> = lazy_env_parse!(
    bytes,
...
/// MiB to 16 MiB)
pub(super) static ROCKSDB_COMPACTION_READAHEAD_SIZE: LazyLock<usize> = lazy_env_parse!(
    bytes,
...
pub(super) static ROCKSDB_STORAGE_LOG_LEVEL: LazyLock<String> = lazy_env_parse!(
...
pub(super) static ROCKSDB_COMPACTION_STYLE: LazyLock<String> = lazy_env_parse!(
...
pub(super) static ROCKSDB_BLOB_FILE_SIZE: LazyLock<u64> = lazy_env_parse!(
    bytes,
...
pub(super) static ROCKSDB_BLOB_COMPACTION_READAHEAD_SIZE: LazyLock<u64> = lazy_env_parse!(
    bytes,
...
pub(super) static ROCKSDB_BACKGROUND_FLUSH_INTERVAL: LazyLock<u64> = lazy_env_parse!(
    duration,
...
pub(super) static ROCKSDB_GROUPED_COMMIT_TIMEOUT: LazyLock<u64> = lazy_env_parse!(
    duration,
