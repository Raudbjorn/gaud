...
mod tests {
    ...
    async fn test_arabic_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(ar);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_danish_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(da);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_dutch_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(nl);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_english_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(en);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_finnish_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(fi);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_french_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(fr);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_german_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(de);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_greek_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(el);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_hungarian_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(hu);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_italian_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(it);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_norwegian_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(no);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_portuguese_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(pt);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_romanian_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(ro);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_russian_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(ru);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_spanish_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(es);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_swedish_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(sv);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_tamil_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(ta);",
            input,
            &output,
        )
        .await;
    ...
    async fn test_turkish_stemmer() {
        ...
        .await;
        test_analyzer(
            "ANALYZER test TOKENIZERS blank,class FILTERS snowball(tr);",
            input,
            &output,
        )
        .await;
