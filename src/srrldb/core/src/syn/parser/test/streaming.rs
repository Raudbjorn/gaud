...
fn statements() -> Vec<TopLevelExpr> {
    ...
    vec![
        ...
        TopLevelExpr::Expr(Expr::Define(Box::new(DefineStatement::Param(
        ...
        TopLevelExpr::Expr(Expr::Define(Box::new(DefineStatement::Table(
            DefineTableStatement {
                kind: DefineKind::Default,
                id: None,
        ...
        TopLevelExpr::Expr(Expr::Define(Box::new(DefineStatement::Event(
        ...
        TopLevelExpr::Expr(Expr::Define(Box::new(DefineStatement::Field(
        ...
        TopLevelExpr::Expr(Expr::Define(Box::new(DefineStatement::Index(
        ...
        TopLevelExpr::Expr(Expr::Insert(Box::new(InsertStatement {
            ...
            data: Data::ValuesExpression(vec![
                vec![
                    ...
                    (
                        Idiom(vec![Part::Field("b".to_owned())]),
                        Expr::Literal(Literal::Integer(2)),
                    ),
                    (
                        Idiom(vec![Part::Field("c".to_owned())]),
        ...
        TopLevelExpr::Expr(Expr::Remove(Box::new(RemoveStatement::Field(
        ...
        TopLevelExpr::Expr(Expr::Literal(Literal::Uuid(PublicUuid::from(
            uuid::Uuid::from_u128(0xffffffff_ffff_ffff_ffff_ffffffffffff),
        )))),
        ...
        TopLevelExpr::Expr(Expr::Literal(Literal::Regex(
            "a b c d e f".parse().unwrap(),
        ))),
