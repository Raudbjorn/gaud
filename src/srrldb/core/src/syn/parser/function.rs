...
mod test {
    ...
    fn function_single() {
        ...
        let Expr::FunctionCall(f) = out else { panic!() };
    ...
    fn function_single_not() {
        ...
        assert_eq!(
            f.arguments,
            vec![sql::Expr::Literal(sql::Literal::Integer(10))]
        );
    }
    ...
    fn function_arguments() {
        ...
        assert_eq!(
            f.receiver,
            Function::Normal(String::from("string::is_numeric"))
        );
    ...
    fn function_simple_together() {
        ...
        assert_eq!(
            f.receiver,
            Function::Script(sql::Script::from(" return 'test'; "))
        );
        assert_eq!(f.arguments, vec![]);
    }
    ...
    fn script_basic() {
        ...
        assert_eq!(
            f.receiver,
            Function::Script(sql::Script::from("return true;"))
        );
        assert_eq!(f.arguments, vec![]);
    }
