...
pub fn convert_response_value(response: &mut ApiResponse, strategy: BodyStrategy) -> Result<()> {
    match strategy {
        BodyStrategy::Auto | BodyStrategy::Json => {
            ...
            response
                .headers
                .insert(CONTENT_TYPE, api_format::JSON.try_into()?);
        }
        BodyStrategy::Cbor => {
            response.body = PublicValue::Bytes(PublicBytes::from(
            ...
            response
                .headers
                .insert(CONTENT_TYPE, api_format::CBOR.try_into()?);
        }
        BodyStrategy::Flatbuffers => {
            ...
            response
                .headers
                .insert(CONTENT_TYPE, api_format::FLATBUFFERS.try_into()?);
        }
        BodyStrategy::Bytes => {
            ...
            response
                .headers
                .insert(CONTENT_TYPE, api_format::OCTET_STREAM.try_into()?);
        }
        BodyStrategy::Plain => {
            ...
            response
                .headers
                .insert(CONTENT_TYPE, api_format::PLAIN.try_into()?);
        }
        BodyStrategy::Native => {
            response
                .headers
