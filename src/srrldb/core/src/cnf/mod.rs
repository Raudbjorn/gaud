...
/// (default: 10 MiB)
pub static TRANSACTION_CACHE_SIZE: LazyLock<usize> = lazy_env_parse!(
    bytes,
...
/// (default: 100 MiB)
pub static DATASTORE_CACHE_SIZE: LazyLock<usize> = lazy_env_parse!(
    bytes,
...
/// (default: 500 MiB)
pub static SURREALISM_CACHE_SIZE: LazyLock<usize> = lazy_env_parse!(
    bytes,
