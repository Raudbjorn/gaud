...
#[allow(
    dead_code,
    reason = "Some variants are only used by specific KV stores"
)]
pub(crate) enum Error {
    ...
    InvalidContent { value: Value },

    /// There was an error with the SQL query
    #[error("Cannot use {} in a MERGE clause", value.to_sql())]
    InvalidMerge { value: Value },
    ...
    InvalidAggregationSelector { expr: String },
    ...
    InvalidVectorDimension { current: usize, expected: usize },
    ...
    QueryNotExecuted { message: String },
    ...
    FieldReadonly { record: String, field: Idiom },
    ...
    FieldUndefined { table: String, field: Idiom },
    ...
    NoIndexFoundForMatch { exp: String },
    ...
    DuplicatedMatchRef { mr: MatchRef },
    ...
    UnsupportedDestructure { variant: String },
    ...
    InvalidBound { found: String, expected: String },

    /// Found an unexpected value in a range
    #[error("Exceeded the idiom recursion limit of {limit}.")]
    IdiomRecursionLimitExceeded { limit: u32 },
