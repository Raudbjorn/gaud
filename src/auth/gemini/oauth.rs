...
//!
//! ```rust,ignore
//! use gaud::gemini::{generate_pkce, generate_state, build_authorization_url};
//! use gaud::gemini::constants::DEFAULT_OAUTH_CONFIG;
//!
...
use crate::gemini::constants::OAuthConfig;
...
///
/// ```
/// use gaud::gemini::generate_state;
///
...
mod tests {
    ...
    fn test_build_authorization_url_contains_required_params() {
        use crate::gemini::constants::DEFAULT_OAUTH_CONFIG;
