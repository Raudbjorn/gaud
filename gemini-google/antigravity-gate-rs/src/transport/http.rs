...
use crate::models::google::CloudCodeWrapper;
...
///
/// ```rust,ignore
/// use antigravity_gate::transport::HttpClient;
///
...
///
/// ```rust
/// use antigravity_gate::transport::HttpClientBuilder;
/// use std::time::Duration;
///
...
pub(crate) fn wrap_request(
    project_id: &str,
    model: &str,
    request: crate::models::google::GoogleRequest,
) -> CloudCodeWrapper {
...
///
/// ```
/// use antigravity_gate::transport::http::mask_token;
///
...
pub fn build_api_path(streaming: bool) -> &'static str {
    if streaming {
        crate::constants::API_PATH_STREAM_GENERATE_CONTENT
    } else {
        crate::constants::API_PATH_GENERATE_CONTENT
    }
}
...
mod tests {
    ...
    fn test_build_api_path() {
        assert_eq!(build_api_path(false), "/v1internal/generate_content");
        assert_eq!(build_api_path(true), "/v1internal/stream_generate_content");
    }
    ...
    fn test_wrap_request() {
        use crate::models::google::{Content, GoogleRequest, Part};
