...
///
/// ```
/// use antigravity_gate::constants::{get_model_family, ModelFamily};
///
...
///
/// ```
/// use antigravity_gate::constants::is_thinking_model;
///
...
pub const API_PATH_GENERATE_CONTENT: &str = "/v1internal/generate_content";

/// Path for streamGenerateContent API (streaming).
pub const API_PATH_STREAM_GENERATE_CONTENT: &str = "/v1internal/stream_generate_content";
