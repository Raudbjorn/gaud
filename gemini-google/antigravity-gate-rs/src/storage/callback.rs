...
///
/// ```rust,ignore
/// use antigravity_gate::storage::CallbackStorage;
...
impl CallbackStorage {
    ...
    ///
    /// ```rust,ignore
    /// use antigravity_gate::storage::{CallbackStorage, FileSource};
    ///
    ...
    ///
    /// ```rust,ignore
    /// use antigravity_gate::storage::{CallbackStorage, EnvSource};
    ///
...
///
/// ```rust,ignore
/// use antigravity_gate::storage::FileSource;
///
/// let source = FileSource::new("~/.myapp/token.json")?;
...
///
/// ```rust
/// use antigravity_gate::storage::EnvSource;
///
/// let source = EnvSource::new("MY_APP_TOKEN");
...
mod tests {
    ...
    fn test_env_source_invalid_json() {
        ...
        std::env::set_var(var_name, "not valid json");
