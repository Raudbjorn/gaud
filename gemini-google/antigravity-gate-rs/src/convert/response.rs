...
///
/// ```rust,ignore
/// use antigravity_gate::convert::convert_response;
///
/// let google_response = /* ... */;
...
pub(crate) fn convert_response(response: &GoogleResponse, model: &str) -> MessagesResponse {
    ...
    MessagesResponse {
        ...
        role: crate::models::request::Role::Assistant,
        content,
...
mod tests {
    use super::*;
    use crate::models::google::{Candidate, Content, FunctionCall, Part, UsageMetadata};
    use serde_json::json;
    ...
    fn test_convert_simple_text_response() {
        ...
        assert_eq!(result.role, crate::models::request::Role::Assistant);
