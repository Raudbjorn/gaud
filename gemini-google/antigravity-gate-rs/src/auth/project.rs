...
//!
//! ```rust,ignore
//! use antigravity_gate::auth::project::{discover_project, ProjectInfo, SubscriptionTier};
//!
...
impl std::str::FromStr for SubscriptionTier {
    ...
    ///
    /// ```
    /// use antigravity_gate::auth::project::SubscriptionTier;
    /// use std::str::FromStr;
    ///
...
///
/// ```rust,ignore
/// use antigravity_gate::auth::project::discover_project;
///
/// # async fn example() -> antigravity_gate::Result<()> {
...
///
/// ```rust,ignore
/// use antigravity_gate::auth::project::onboard_user;
///
/// # async fn example() -> antigravity_gate::Result<()> {
